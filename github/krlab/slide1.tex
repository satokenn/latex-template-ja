...
\begin{frame}{画角の求め方}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[scale=0.1]{figure/02.png}
    \caption{画角の求め方}
    \label{fig:02}
  \end{figure}
\end{frame}
...
\begin{frame}{レンズ焦点距離}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[scale=0.1]{figure/04.png}
    \caption{後側主点と後側焦点}
    \label{fig:04}
  \end{figure}
\end{frame}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.1]{figure/03.png}
...
\begin{frame}[allowframebreaks]{移動ブレの防止}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[scale=0.1]{figure/05.png}
...
\begin{frame}[allowframebreaks]{被写界深度}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[scale=0.1]{figure/06.png}
...
\end{block}
  ...
  \begin{figure}[H]
    ...
    \begin{minipage}[b]{0.33\columnwidth}
        \centering
        \includegraphics{figure/07.png}
        \caption{Aよりも近い位置の被写体は，撮像素子よりも後でピントが合う}
        \label{fig:b}
    \end{minipage}
    \begin{minipage}[b]{0.33\columnwidth}
        \centering
        \includegraphics{figure/08.png}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[scale=0.1]{figure/09.png}
      \caption{被写界深度のまとめ}
      \label{fig:09}
    \end{figure}
